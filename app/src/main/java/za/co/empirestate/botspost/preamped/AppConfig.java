...
/**
 * Created by George_Kapoya on 15/11/22.
 */
public class AppConfig {

    public static final String URL_BOTS = "http://utc.empirestate.co.za/bostwana_post_office/additional_meter_INS.php";
    public static final String URL_VERIFY = "http://utc.empirestate.co.za/bostwana_post_office/verify_meter.php";
