 ...
 */
public class PoAdapter extends  RecyclerView.Adapter<PoAdapter.AirtimeViewHolder> implements View.OnClickListener  {

    private List<History> historyList;
    private Context context;
    private Context mContext;
    private ImageLoader mImageLoader;
    public PoAdapter(Context context, List<History> historyList) {
    ...
    public AirtimeViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.pob_item, viewGroup, false);
